...
/**
 * This is an abstract Number validator. It is used to add number based validators.
 *
 * @author G Brown
 *
 * @param <C>
 *            An object class such as String, Boolean, Character, Short, Integer, etc.
 */
public abstract class NumberValidator<C extends Number> extends ObjectValidator<C> {
    ...
    /*
     * A flag indicating that a positive value test will be performed when the validate() method is called.
     */
    protected boolean _isTestPositiveValue = false;

    /*
     * A flag indicating that a negative value test will be performed when the validate() method is called.
     */
    protected boolean _isTestNegativeValue = false;

    /*
     * A flag indicating that a zero value test will be performed when the validate() method is called.
     */
    ...
    /**
     * A method to mark that an "max value" test will be performed when the validate() method is called. Tests if the
     * value is less than or equal to the max value when the validate method is called.
     *
     * @param maxValue
    ...
    /**
     * A method to mark that an "min value" test will be performed when the validate() method is called. Tests if the
    ...
    /**
     * A method to mark that an "zero value" test will be performed when the validate() method is called. Tests if the
     * value is greater than or equal to the min value when the validate method is called.
     *
    ...
    /**
     * A method to mark that an "positive value" test will be performed when the validate() method is called. Tests if
     * the value is greater than or equal to the min value when the validate method is called.
     *
     * @return The same NumberValidator instance. This allows for method chaining.
     */
    ...
    /**
     * A method to mark that an "negative value" test will be performed when the validate() method is called. Tests if
     * the value is greater than or equal to the min value when the validate method is called.
     *
     * @return The same NumberValidator instance. This allows for method chaining.
     */
    ...
    protected boolean validateZeroValue() {
        ...
        if (this._isTestZeroValue) {
            ...
            if (this._isValidationExceptionThrownOnFail && !isValid) {
                ObjectValidator
                        .throwValidateException("The value is not a zero value x = 0 (value = '" + this._value + "').");
            }
        }
        return (isValid);
    }
        ...
        if (this._isTestPositiveValue) {
            ...
            if (this._isValidationExceptionThrownOnFail && !isValid) {
                ObjectValidator.throwValidateException(
                        "The value must be be a positive value x > 0 (value = '" + this._value + "').");
            }
        }
        return (isValid);
    }
    ...
    protected boolean validateNegativeValue() {
        ...
        if (this._isTestNegativeValue) {
            ...
            if (this._isValidationExceptionThrownOnFail && !isValid) {
                ObjectValidator.throwValidateException(
                        "The value must be be a negative value x < 0 (value = '" + this._value + "').");
            }
        }
        return (isValid);
    }
