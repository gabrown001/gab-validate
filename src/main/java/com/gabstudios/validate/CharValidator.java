...
/**
 * This is a char validator. After this class is created, call the testXXXX() methods to perform tests when the
 * validate() method is called. Validate.defineChar(char).testNotNull().validate(); If the
 * throwValidationExceptionOnFail() method has been called and if the validate fails then a ValidateException will be
 * thrown. Validate.defineChar(char).testEquals(char) .throwValidationExceptionOnFail().validate(); If no test method is
...
public final class CharValidator extends ObjectValidator<Character> {
    ...
    /*
     * A flag indicating if an "is the character a digit/number" test will be performed when the validate() method is
     * called.
     */
    private boolean _testIsDigit = false;

    /*
     * A flag indicating if an "is the character lower case" test will be performed when the validate() method is
     * called.
     */
    private boolean _testIsLowerCase = false;

    /*
     * A flag indicating that a max value test will be performed when the validate() method is called.
     */
    private boolean _isTestMaxValue = false;

    /*
     * A flag indicating that a min value test will be performed when the validate() method is called.
     */
    ...
    /*
     * A flag indicating if an "is the character upper case" test will be performed when the validate() method is
     * called.
     */
    private boolean _testIsUpperCase = false;

    /*
     * A flag indicating if an "is the character a white space" test will be performed when the validate() method is
     * called.
     */
    ...
    /**
     * A method to mark that a max value test will be performed when the validate() method is called. The value must be
     * less than or equal to the maxValue.
     *
     * @param maxValue
    ...
    /**
     * A method to mark that a min value test will be performed when the validate() method is called. The value must be
     * less than or equal to the minValue.
     *
     * @param minValue
    ...
    /**
     * A method to mark that an "not empty" test will be performed when the validate() method is called.
     *
     * @return The same CharValidator instance. This allows for method chaining.
     */
    ...
    /**
     * A method to mark if an "is the character a digit/number" test will be performed when the validate() method is
     * called.
     *
     * @return The same CharValidator instance. This allows for method chaining.
     */
    ...
    /**
     * A method to mark if an "is the character lower case" test will be performed when the validate() method is called.
     * Calling this method will de-active the isUpperCase test.
     *
     * @return The same CharValidator instance. This allows for method chaining.
     */
    ...
    /**
     * A method to mark if an "is the character upper case" test will be performed when the validate() method is called.
     * Calling this method will de-active the isLowerCase test.
     *
     * @return The same CharValidator instance. This allows for method chaining.
     */
    ...
    /**
     * A method to mark if an "is the character a whitecase" test will be performed when the validate() method is
     * called. Calling this method will de-active the isLowerCase test.
     *
     * @return The same CharValidator instance. This allows for method chaining.
     */
    ...
    protected boolean validateNotEmpty() {
        ...
        if (this._isTestNotEmpty) {
            ...
            if (this._isValidationExceptionThrownOnFail && !isValid) {
                ObjectValidator.throwValidateException("The char must not be empty.");
            }
        }
        return (isValid);
    }
    ...
    protected boolean validateIsDigit() {
        ...
        if (this._testIsDigit) {
            ...
            if (this._isValidationExceptionThrownOnFail && !isValid) {
                ObjectValidator.throwValidateException("The char is not a digit (value = '" + this._value + "').");
            }
        }
        return (isValid);
    }
    ...
    protected boolean validateIsLowerCase() {
        ...
        if (this._testIsLowerCase) {
            ...
            if (this._isValidationExceptionThrownOnFail && !isValid) {
                ObjectValidator.throwValidateException("The char is not lower case (value = '" + this._value + "').");
            }
        }
        return (isValid);
    }
    ...
    protected boolean validateIsUpperCase() {
        ...
        if (this._testIsUpperCase) {
            ...
            if (this._isValidationExceptionThrownOnFail && !isValid) {
                ObjectValidator.throwValidateException("The char is not upper case (value = '" + this._value + "').");
            }
        }
        return (isValid);
    }
    ...
    protected boolean validateWhitespace() {
        ...
        if (this._testIsWhitespace) {
            ...
            if (this._isValidationExceptionThrownOnFail && !isValid) {
                ObjectValidator.throwValidateException("The char is not a whitespace (value = '" + this._value + "').");
            }
        }
        return (isValid);
    }
