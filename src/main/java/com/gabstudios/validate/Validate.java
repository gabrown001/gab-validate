...
/**
 * The purpose of this class is to help validate arguments. Use the appropriate defineXXXXX(xxx) method to get a
 * validator instance. Then call methods on that validator to enable the tests that will be performed when the
 * validate() method is called. The default return from a validate() - if no tests are selected is TRUE.
 *
 * @author G Brown
 */
public class Validate {
    ...
    /**
     * This method defines a boolean validator. Each call creates a new validator.
     *
     * @param value
    ...
    /**
     * This method defines a double validator. Each call creates a new validator.
     *
     * @param value
    ...
    /**
     * This method defines a integer validator. Each call creates a new validator.
     *
     * @param value
    ...
    /**
     * This method defines a String validator. Each call creates a new validator.
     *
     * @param value
